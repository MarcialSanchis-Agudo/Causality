...
def main():
    ...
    print('------------ LOADING DATA ----------------')
    datapath_U = '/mimer/NOBACKUP/groups/kthmech/abhvis/Projects/UFLOW_data/obstacleNOTRIP_T_233_283_N5e/DATASET24e/U.mat'
    datapath_V = '/mimer/NOBACKUP/groups/kthmech/abhvis/Projects/UFLOW_data/obstacleNOTRIP_T_233_283_N5e/DATASET24e/V.mat'
    datapath_W = '/mimer/NOBACKUP/groups/kthmech/abhvis/Projects/UFLOW_data/obstacleNOTRIP_T_233_283_N5e/DATASET24e/W.mat'
   ...
   # Adjust values to max and min value (avoid precision errors) 
    ...
    m.save('/mimer/NOBACKUP/groups/kthmech/carlos/Datasets_3D/Obstacle_VAE/obstacle_3D_24.h5', nopartition=True)
    print("Mesh saved")
    d.save('/mimer/NOBACKUP/groups/kthmech/carlos/Datasets_3D/Obstacle_VAE/obstacle_3D_24.h5', nopartition=True)
